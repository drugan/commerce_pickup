...
/**
 * Bulk edit pickup stores.
 *
 * @Action(
 *   id = "commerce_pickup_stores",
 *   label = @Translation("Edit pickup stores"),
 *   type = "profile"
 * )
 */
class PickupStores extends ActionBase {
  ...
  public function executeMultiple(array $profiles) {
    if ($profiles) {
      ...
      $path = $url::fromRoute('commerce_pickup.config_action_pickup_stores', [], ['query' => $query])->toString();
