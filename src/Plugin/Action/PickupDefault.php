...
/**
 * Sets default pickup point.
 *
 * @Action(
 *   id = "commerce_pickup_default",
 *   label = @Translation("Set default pickup point"),
 *   type = "profile"
 * )
 */
class PickupDefault extends ActionBase {
  ...
  public function executeMultiple(array $profiles) {
    if ($profiles) {
      ...
      $path = $url::fromRoute('commerce_pickup.config_action_pickup_default', [], ['query' => $query])->toString();
